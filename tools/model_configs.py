...
settings so the benchmarks remain practical on 8/16-GPU nodes. Entries ending
in ``_proxy`` keep the public model's MoE dimensions but map unsupported
attention variants onto the current MHA/GQA benchmark block.
"""
...
MODEL_CONFIGS: Dict[str, Dict[str, Any]] = {
    ...
    # ------------------------------------------------------------------
    # Modern long-context MoE proxy presets
    # These keep the public MoE dimensions while adapting attention to the
    # benchmark block assumptions.
    # ------------------------------------------------------------------
